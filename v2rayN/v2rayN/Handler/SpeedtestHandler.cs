...
namespace v2rayN.Handler
{
    class SpeedtestHandler
    {
        ...
        public SpeedtestHandler(ref Config config, ref V2rayHandler v2rayHandler, List<int> selecteds, string actionType, Action<int, string> update,Action action,Action selectFasterServer)
        {
            _config = config;
            _v2rayHandler = v2rayHandler;
            //_selecteds = Utils.DeepCopy(selecteds);
